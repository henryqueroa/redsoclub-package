# Evergreen Loom Script: Para Diego y María Valeria

> Script para grabar yo (Henryque / Zytrom). 2-3 minutos. En español, tutear, sin em dashes. Pantalla comparte la hub page.
...
"Y por último el outline de un VSL completo de 6-8 minutos para la membresía."

---

## Close (2:00 - 2:30)

**[Cámara on, sin pantalla]**

"Todo esto es de ustedes, lo usen o no lo usen, trabajemos juntos o no. Lo dejé montado para que puedan agarrar lo que sirva."
...
## Producción notes
- Grabar con Loom en 1080p
- Cámara webcam abajo a la derecha
- Pantalla compartida en grande
- Velocidad natural, no acelerar
- Tono: tranquilo, sin hype, sin venderse
- Mostrar la URL de Calendly al final en la pantalla o en la descripción del Loom
